public class VectorField {
    ...
    private static final float baseForce = 0.4;
    ...
    public VectorField shuffle() {
        ...
        for (Entity e : entities)  {
            ...
            force.multiply(1/length);
            force.multiply((float)Math.exp(-0.001 * length + 5.6));
